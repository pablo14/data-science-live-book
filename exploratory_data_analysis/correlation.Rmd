...
```{r mic_non_linear_relationship, message=FALSE}
...
```{r measuring_non_linearity, message=FALSE, fig.width=8, fig.height=3, out.width="600px"}
...
```{r monotonic_non-monotonic_function, fig.height=3.5, fig.width=8, out.width="600px"}
...
```{r profiling_target_variable, fig.height=2, fig.width=3, out.width = "300px", out.height= "200px"}
...
```{r importance_variable_ranking, fig.width=6, fig.height=4.5}
