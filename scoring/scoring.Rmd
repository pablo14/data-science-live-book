...
**Accuracy Metric or Confusion Matrix must always be attached to a certain cut point.**
...
**The analysis of extremes will help us to find the right balance**
...
:thumbsdown: The worst escenario -the opposite to last example- is when **FP** and **FN** rates are 100%. Not even randomness can achieve such a awful escenario. 
...
A classifier that always predicts `yes`, will have a TP of 100%, but is absolutly useless since the FP rate will be quite high -a lot of `yes` will be actually `no`. ROC 
