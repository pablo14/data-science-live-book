...
### An intuitive and practical approach to data analysis, data preparation and machine learning, suitable for all ages! `r emo::ji("rocket")`
...
* **Book technical reviewer:** `r emo::ji("hammer_and_wrench")`: **Pablo Seibelt** (https://twitter.com/sicarul)
