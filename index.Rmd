...
Also, you can check the **Github** repositories for both, the b ook and `funModeling`, so you can report bugs, suggestions, new ideas, etc:
...
Art cover made: [Bárbara Muñoz](https://www.linkedin.com/in/barbaramercedes/)`r emo::ji("art")`.
