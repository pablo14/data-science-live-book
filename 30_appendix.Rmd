...
```{r, profiling_numerical_variable, warning=FALSE, message=FALSE, fig.height=3, fig.width=4, tidy=FALSE}
quantiles_var = 
...
```{r distribution_categorical_variable, message=FALSE, fig.height=3, fig.width=5, warning=FALSE, warning=FALSE}
library(dplyr)
...
```{r profiling_variable_predictive_modeling, fig.height=4, fig.width=8, results=FALSE}
