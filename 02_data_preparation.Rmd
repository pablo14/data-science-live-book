...
```{r equal_range_discretization_a, tidy=FALSE}
...
```{r, equal_range_discretization, fig.width=4, fig.height=3, tidy=FALSE}
...
```{r equal_frequency_discretization, fig.width=4, fig.height=3, tidy=FALSE}
...
```{r discretization_custom_bins, fig.width=4, fig.height=3, tidy=FALSE}
...
```{r data_preparation_nominal_variable, fig.height=9, fig.width=5, dpi=300}
...
```{r categorical_outliers_1, echo=FALSE, message=FALSE, warning=FALSE}
library(funModeling)
library(dplyr)
...
```{r missing_value_imputation, fig.height=4, fig.width=7, tidy=FALSE}
