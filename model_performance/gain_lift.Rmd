...
Both metrics are extremly useful to validate the predictive model (binary outcome) quality. More info about scoring (here)[http://livebook.datascienceheroes.com/scoring/scoring.html]
