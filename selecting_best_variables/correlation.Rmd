...
**In practice:** To generate data based on a function is only for teaching purposes. But the concept of noisy in variables is quite common in almost every data set. Machine learning models deal with this noise, by infering the _real_ shape of data.
It's quite useful to use the MIC measure to get a sense about the information present in a relationship.
...
* MAS ~ 1 indicates non-monotonic function
...
mine(df_time_series)$MIC
mine(df_time_series)$MAS
