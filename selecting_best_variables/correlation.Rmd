...
A high MIC value indicates that the relationship between the two variables can be explain through a function, or a predictive model.

These methods didn't tell us what is that function nor predictive model. 



So, if there is no information in the variable then no-one predictive model will be useful.

Some of them may be more accurate than others, yes, but if the relationship is absolutely noisy no matter how advance the algorithm is, it will end up in bad results. We can quote the famous phrase:
...
Recommended lecture: http://www.scholarpedia.org/article/Mutual_information
