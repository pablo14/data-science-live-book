...
Outliers can be treated with `prep_outliers` function, present in this package. TODO: exand it
...
4-different plots, having the same `mean` for every `x` and `y` (9 and 7.501 respectively), and the same degree of correlation. You can check all the measures by `summary(anscombe_data)`. 
