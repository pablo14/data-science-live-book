...
When getting the ranking list, try to use predictive models which contains re-sampling, bootstrapping, bagging
 and perform a cross-validation with repetition. 
