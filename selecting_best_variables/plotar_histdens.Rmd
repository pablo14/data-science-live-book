...
_Something similar is what a **statistical test** sees: they measured **how different** the curves are reflecting it in some statistics (like the p-value), in order to give to the analyst,  reliable information to determine if the curves have -for example- the same mean._
