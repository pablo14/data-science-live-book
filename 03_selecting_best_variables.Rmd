...
```{r variable_ranking_using_information_theory, fig.width=6, fig.height=4.5, tidy=FALSE}
variable_importance = 
...
```{r variable_importance_c5, results="hide",fig.height=4, fig.width=9.9, tidy=FALSE}
...
```{r feature_engineering, results="hide", fig.height=4, fig.width=9.5, tidy=FALSE}
