...
```{r selecting-best-variables-5, echo=FALSE, out.width="54%", fig.cap="Aristotle (367 BC–347 BC)", out.extra=""}
...
```{r variable-ranking-using-information-theory, fig.width=6, fig.height=4.5, tidy=FALSE, fig.cap="Variable Importance (based on Information Gain)", out.extra=""}
variable_importance = 
...
```{r cross-plot-feature-engineering, results="hide",fig.height=4, fig.width=9.5, fig.cap="Numeric variable as input (automatic binning)", out.extra=""}
...
```{r variable-importance2b,  fig.height=3, fig.width=5, fig.cap="Pofiling target using boxplot", out.extra=""}
...
```{r boxplot-analysis, echo=FALSE, out.width="230px", fig.cap="How to interpret a boxplot", out.extra=""}
