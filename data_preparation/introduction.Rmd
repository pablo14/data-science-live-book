...
E.g. person `Mamarul` traveled `34` to `South_Africa` country.
...
Other times there are random cases, like a machine which fails in collecting the data, or an user who forgot to complete a form, among others.
