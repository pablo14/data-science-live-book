...
<img src="fibonacci_spiral.jpg" alt="Fibonnacci curve, numeric and categoric?" width="150px">
...
It's good practice to assign the minimum and maximum using a function. In this case, the variable is a percentage, so we know beforehand its scale is from 0 to 100; however, ⚠️ _what would happen if we did not know the range?_ 
