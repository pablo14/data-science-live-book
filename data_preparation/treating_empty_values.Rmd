...
`mice` has many functions to help us the process, and validate the filling results.bBt to keep it very simple, we'll cover just a little part of it,. Following example will focus on extracting a **data frame with no-missing values ready to be used** with other program or predictive model. 
**Example in R:**
