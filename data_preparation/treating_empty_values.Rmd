...
The Imputation methods when the missing values, irea ral missing value, a**rda"a cntrolled-bias"**, to we have not to exclude the variables from the analysis nor the predictive model.
