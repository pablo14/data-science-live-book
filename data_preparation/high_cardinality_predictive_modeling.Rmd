...
`recateg_results`: Is a data frame wich is useful to profile each group (`country_rec`). The predictive model will _see_ these groups:
...
Now the ROC is ~ **0.71**, which is an improvement of ~ **6%** compared to the previous model.
