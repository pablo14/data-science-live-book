...
```{r high_cardinality_variable,  fig.height=9, fig.width=5, out.width="700px"}
...
**Improvement: ~ `r round(100*(new_roc-roc)/roc,2)`%**.
...
This opens a new chapter which is going to be covered in this book `emo::ji("wink")`:**Feature engineering** or **selecting best variables**. It is a highly recommended practise to first select those variables which carry the most information, and then create the predictive model.
