...
No, they are the same. The Data Science Live Book is and will always be fully accessible, actually it's open source  (`Attribution-NonCommercial-ShareAlike 4.0 International`). The portable versions will have priority for the newest changes.
