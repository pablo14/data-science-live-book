...
MIC will not be helpful for more complex esenarios having time series which vary in speed, you would use [dynamic time wrapping](https://en.wikipedia.org/wiki/Dynamic_time_warping) technique (**DTW**).

Let's use an image to catch up the concept visually:


```{r Dynamic_Time_Wrapping, echo=FALSE, out.width="300px"}
knitr::include_graphics("exploratory_data_analysis/dynamic_time_wrapping.png")
```
