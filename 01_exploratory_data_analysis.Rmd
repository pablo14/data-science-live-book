...
```{r anscombe_data, message=FALSE, tidy=FALSE}
...
```{r measuring_non_linearity, message=FALSE, fig.width=8, fig.height=3, tidy=FALSE}
...
```{r monotonic_non-monotonic_function, fig.height=3.5, fig.width=8, tidy=FALSE}
...
```{r correlation_time_series, fig.height=3, fig.width=5, tidy=FALSE}
# reading data
df_time_series = 
...
```{r dummy_vars, message=FALSE, tidy=FALSE}
library(caret)
...
```{r correlation_information_theory, tidy=FALSE}
...
```{r importance_variable_ranking, fig.width=6, fig.height=4.5, tidy=FALSE}
