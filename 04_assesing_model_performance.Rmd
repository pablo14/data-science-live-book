...
```{r model-performance-workflow, echo=FALSE, out.width="100%", fig.cap="A validation worflow for time dependant problems", out.extra=''}
...
```{r gain-lift-analysis, echo=FALSE, out.width="300px", fig.cap="Gain and lift curves", out.extra=''}
